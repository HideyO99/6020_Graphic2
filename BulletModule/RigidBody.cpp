...
void RigidBody::GetPosition(Vec3& position)
{
...
void RigidBody::ApplyForceAtPoint(const Vec3& force, const Vec3& relativePoint)
{
	btVector3 btForce;
...
void RigidBody::ApplyImpulseAtPoint(const Vec3& impulse, const Vec3& relativePoint)
{
	btVector3 btImpulse;
